...
mt_ing_price <- div(
  h2("The ingredients required are as follows:",
     column(12,"Milk: $0.6"),
     column(12,"Tea: $0.3"),
     column(12,"Pearl: $0.5"),
     column(12,"Ice: $0.2")),
...
# deficiency_updated_mt <- fluidPage(
#   shinyjs::useShinyjs(),
#   h2("Test deficiency pop up:"),
#   fluidRow(
#     column(6,
#            numericInput("mtuserdeficiency","Number of cups of milk tea to make:", 500, min=0, max=500),
#            verbatimTextOutput("mtuservalue"),),
#     column(6,
#            numericInput("mtuserdeficiency","Number of cups of milk tea to make:",0),
#            verbatimTextOutput("ftuservalue"))
#   )
# )
