...
# source("components/loginPage/setAWSPassword.R")
...
ui <- navbarPage(
  ...
  # tabPanel(d="leaderboardtab", "lb", leaderboardui),
  # tags$audio(src = "Euphoria.mp3", type = "audio/mp3", autoplay = NA, controls = NA),
  # tags$audio(src = "beautiful.mp3", type = "audio/mp3", autoplay = NA, controls = NA),
)
...
server <- function(input, output, session) {
  ...
  observeEvent(input$submit, {
    ...
    if (needPopup == 1) {
      ...
      # deficiency alert
      shinyalert(class = "deficiency-alert","Deficiency", 
                 inputId = "deficiencyalert",
                 imageUrl="https://i.ibb.co/TqyV8kr/Screenshot-2022-07-28-at-9-13-28-PM.png", 
                 type = "warning", html=T, 
                 text=tagList(renderDeficiencyPopUp(dailyPurchase$total_possible,dailyPurchase$mt_possible, 
